...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, NgForOf, ReactiveFormsModule, HttpClientModule],
...
export class AppComponent {
  ...
  productsData : any[] = [
    ...
    },
    {
      ...
      text : "Зачем выбирать один, когда можно получить их все? Наш классический ассортимент печенья включает в себяпо одному из четырёх оригинальных вкусов печенья.",
      price : 36,
      basePrice : 36,
      weight : "4 шт./ 400 гр.",
    },
